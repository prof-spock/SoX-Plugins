...
#define _PluginPathName                  eu.tensi.SoXPlugins.ChorusAndEcho

/**  the simple name of the plugin */
#define JucePlugin_Name                  "SoX ChorusAndEcho"

/** the description of the plugin */
#define JucePlugin_Desc                  "chorus, echo or echos effect from SoX"

/** the four byte code for the plugin 'cech' */
#define JucePlugin_PluginCode            0x63656368
...
#define JucePlugin_AUExportPrefix        SoXChorusAndEchoAU

/** the prefix for AU plugins */
#define JucePlugin_AUExportPrefixQuoted  "SoXChorusAndEchoAU"
...
#define JucePlugin_IAAName               "SoX: ChorusAndEcho"
