...
namespace BaseTypes::GenericTypes {
    ...
    struct GenericMatrix {
        ...
        /**
         * Returns list at <C>rowIndex</C> via parenth operator;
         * fails if some index is out of range
         *
         * @param[in] rowIndex     row position of element in matrix
         * @return  element at given matrix position
         */
        GenericList<T>& operator [] (IN Natural rowIndex)
        {
         ...
         * @return  element at given matrix position
         */
        const GenericList<T>& operator [] (IN Natural rowIndex) const
        {
            return _data[rowIndex];
        }
        ...
        private:
            ...
            GenericList<GenericList<T> > _data;
