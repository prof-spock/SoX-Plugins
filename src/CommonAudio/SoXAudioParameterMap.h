/**
 * @file
 * The <C>SoXAudioParameterMap</C> specification defines a map of
 * string keys and associated values of <C>SoXAudioParameterKind</C>;
...
namespace SoXPlugins::CommonAudio {
    ...
    /**
     * The <C>SoXAudioParameterKind</C> is an enumeration type for the
     * kind of parameter for an audio processor parameter.
     */
    enum class SoXAudioParameterKind {
     ...
     */
    String audioParameterKindToString (IN SoXAudioParameterKind& kind);

    /*====================*/

    /**
     * A <C>SoXAudioParameterMap</C> object is a map of string keys
     * and associated values of <C>SoXAudioParameterKind</C>; those
     * values can be set and queried: this provides an interpretative
     * coupling between audio processors and audio editors.
     */
    struct SoXAudioParameterMap {
         ...
         */
        SoXAudioParameterKind kind (IN String& parameterName)
            const;
         ...
         */
        bool isAllowedValue (IN String& parameterName,
         ...
         */
        bool adaptValueEnum (IN String& parameterName,
         ...
         * @return  information whether value is okay
         */
        bool adaptValueInt (IN String& parameterName,
         ...
         * @return  information whether value is okay
         */
        bool adaptValueReal (IN String& parameterName,
         ...
         */
        bool isActive (IN String& parameterName) const;
         ...
         */
        static bool isPageSelector (IN String parameterName);
        ...
        private:
             ...
             *  kind */
            map<String,SoXAudioParameterKind> _parameterNameToKindMap;
