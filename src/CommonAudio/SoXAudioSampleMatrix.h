/**
 * @file
 * The <C>SoXAudioSampleMatrix</C> specification defines a list of ring
...
namespace SoXPlugins::CommonAudio {
    ...
    struct SoXAudioSampleMatrix {
         ...
         *                                    (in samples)
         */
        SoXAudioSampleMatrix (IN Natural channelCount = 0,
