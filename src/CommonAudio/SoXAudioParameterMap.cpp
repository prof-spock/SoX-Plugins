...
namespace CommonAudio = SoXPlugins::CommonAudio;
...
String CommonAudio::audioParameterKindToString (IN SoXAudioParameterKind& kind)
{
    String result;
    ...
    const
{
    ...
    const bool isKey = (_parameterNameToKindMap.find(parameterName)
...
bool SoXAudioParameterMap::isAllowedValue (IN String& parameterName,
...
bool SoXAudioParameterMap::adaptValueEnum (IN String& parameterName,
...
bool SoXAudioParameterMap::adaptValueInt (IN String& parameterName,
...
bool SoXAudioParameterMap::adaptValueReal (IN String& parameterName,
...
bool SoXAudioParameterMap::isActive (IN String& parameterName) const
{
    Logging_trace1(">>: %1", parameterName);
    bool result = _activeParameterNameSet.contains(parameterName);
...
void SoXAudioParameterMap::changeActivenessByPage (IN Natural lastPageIndex)
{
    ...
    for (String& parameterName : _parameterNameList) {
        ...
        const bool isActive = (pageIndex <= lastPageIndex);
...
SoXAudioParameterMap::isPageSelector (IN String parameterName) {
    ...
    _splitParameterName(parameterName, effectiveParameterName,
                        pageIndex, nominalPageIndex);
    const bool isPageSelector = (nominalPageIndex == -1);
